...
This document provides a re-visualisation of Black Thrive's Shared Measurement System dashboard for Lambeth. The dashboard aims to quantify areas of inequality in Britain by comparing various indicators for the Black population compared to the White population. All data presented, apart from the Police Stop and Search data, were sourced by Lambeth Public Health in a previous analysis. The indicators, and the sources of their data (as reported by Lambeth Public Health), are presented in the table below.
